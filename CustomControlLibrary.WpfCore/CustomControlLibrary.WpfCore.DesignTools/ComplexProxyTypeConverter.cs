namespace CustomControlLibrary.WpfCore.DesignTools
{
    ...
    public class ComplexProxyTypeConverter : TypeConverter
    {
        private static List<ComplexProxy> defaultValues = new List<ComplexProxy>();

        static ComplexProxyTypeConverter()
        {
            defaultValues.Add(new ComplexProxy(0, 0));
            defaultValues.Add(new ComplexProxy(1, 1));
            defaultValues.Add(new ComplexProxy(-1, 1));
            defaultValues.Add(new ComplexProxy(-1, -1));
            defaultValues.Add(new ComplexProxy(1, -1));
        }
            ...
            object value)
        {
            ...
            if (text != null)
            {
                try
                {
                    return ComplexProxy.Parse(text);
                }
                catch (Exception e)
                {
                    throw new Exception(
            ...
            Type destinationType)
        {
            ...
            ComplexProxy c = value as ComplexProxy;
